          ...
          <div class="row">
            <div class="col-sx-12 col-sm-4 col-md-4">
              ...
              <div class="info p-20 bg-black-333">
                <h4 class="text-uppercase text-white">{{ Auth::user()->username }}</h4>
                <ul class="list angle-double-right m-0">
                  <li class="mt-0 text-gray-silver"><strong class="text-gray-lighter">Full Name</strong><br> {{ Auth::user()->name }}</li>
                </ul>
                <ul class="list angle-double-right m-0">
                ...
                <a class="btn btn-info btn-flat mt-10 mb-sm-30" href="editprofile">Edit Profile</a>
