@extends('layout')
@section('title', 'Automated Accommodation || Buy House')
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/pagetitle.jpg">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white">Buy an Answerable House</h2>
              <ol class="breadcrumb text-left text-black mt-10">
                
                <li class="active text-gray-silver">Chose your dream house</li>
              </ol>
            </div>
          </div>
        </div>
...
<div class="container">
        <div class="row">
						...
						<div  style="font-size:16px"><p>Here you can choose your dream house from the list below.
