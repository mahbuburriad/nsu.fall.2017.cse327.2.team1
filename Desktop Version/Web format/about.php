...
?>
<title>Automated Accommodation || About the product</title>
<?php
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/pagetitle.jpg">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white">About The Product</h2>
              <ol class="breadcrumb text-left text-black mt-10">
                
                <li class="active text-gray-silver">Know about the product</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-9">
            <div id="section-one" class="mb-50">
              ...
              <p class="mb-20" >Automated Accomodation is the trusted resource for home buyers, sellers, renters and dreamers
								...
								<p>
								Automated Accomodation System helps people in the property market to find their ideal home or commercial property. 
