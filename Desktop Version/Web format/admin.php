...
<section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/pagetitle.jpg">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white">Automated Accommodation || Admin Panel</h2>
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="#">Home</a></li>
                <li class="active text-gray-silver">Admin</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-8 col-md-8">
              <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li role="presentation"><a href="#free-orders" aria-controls="free-orders" role="tab" data-toggle="tab" class="font-15 text-uppercase">Owners</a></li>
                  <li role="presentation"><a href="#bookmarks" aria-controls="bookmarks" role="tab" data-toggle="tab" class="font-15 text-uppercase">transaction <span class="badge">5</span></a></li>
                </ul>
