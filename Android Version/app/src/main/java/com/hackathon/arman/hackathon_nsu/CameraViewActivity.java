...
public class CameraViewActivity extends AppCompatActivity implements
	...
	private void updateDescription() {
		descriptionTextView.setText(String.format("%s azimuthTeoretical %s azimuthReal %s latitude %s longitude %s", mPoi.getPoiName(), mAzimuthTeoretical, mAzimuthReal, mMyLatitude, mMyLongitude));
	}
